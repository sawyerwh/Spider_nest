...
def parse_with_xpath(html):
    ...
    image = etree_html.xpath('//a[@class="nbg"]/img/@src')
    name = etree_html.xpath('//a[@class="nbg"]/img/@alt')
    return image, name
...
def save_image(result):
    ...
    for i in range(len(images)):
            filename = './images/xpath_image/%s.jpg' % names[i]
